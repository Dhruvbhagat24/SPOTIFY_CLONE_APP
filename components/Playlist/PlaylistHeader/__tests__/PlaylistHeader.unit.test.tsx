...
import { PlaylistHeader, PlaylistHeaderPropsType } from '../PlaylistHeader';
...
describe('PlaylistHeader', () => {
  ...
  const defaultProps: PlaylistHeaderPropsType = {
  ...
  beforeEach(() => {
    ...
    container = render(<PlaylistHeader {...defaultProps} />);
  });
