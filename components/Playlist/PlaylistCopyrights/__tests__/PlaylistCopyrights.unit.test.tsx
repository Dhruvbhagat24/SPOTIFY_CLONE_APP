...
import {
  PlaylistCopyrights,
  PlaylistCopyrightsPropsType,
} from '../PlaylistCopyrights';
...
describe('PlaylistCopyrights', () => {
  let container: RenderResult;
  const defaultProps: PlaylistCopyrightsPropsType = {
    copyrights: [
      {
  ...
  it('renders correctly', () => {
    container = render(<PlaylistCopyrights {...defaultProps} />);
  ...
  describe('UI', () => {
    ...
    it('displays all copyright texts and adds the missing C type copyright sign', () => {
      ...
      container = render(<PlaylistCopyrights {...props} />);
