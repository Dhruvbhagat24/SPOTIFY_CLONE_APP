...
import { AlbumBackground, AlbumBackgroundPropsType } from "../AlbumBackground";
...
describe("AlbumBackground", () => {
  let container: RenderResult;
  const defaultProps: AlbumBackgroundPropsType = {
    url: "url",
    darkness: 0.6,
  };

  beforeEach(() => {
    container = render(<AlbumBackground {...defaultProps} />);
  });
